...
/**
 * Load User By Id Repository
 */
const LOAD_USER_BY_ID_REPOSITORY_SUT_EMPTY = Symbol(
  'LOAD_USER_BY_ID_REPOSITORY_SUT_EMPTY',
);
const LOAD_USER_BY_ID_REPOSITORY_SUT_EMPTY_OBJECT = Symbol(
  'LOAD_USER_BY_ID_REPOSITORY_SUT_EMPTY_OBJECT',
);
const LOAD_USER_BY_ID_REPOSITORY_SUT_WITH_EMPTY_USER_MODEL_OBJECT = Symbol(
